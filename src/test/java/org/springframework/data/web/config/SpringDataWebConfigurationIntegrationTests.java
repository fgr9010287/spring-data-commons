...
public class SpringDataWebConfigurationIntegrationTests {
	...
	@Test // DATACMNS-987
	@ClassLoaderConfiguration(hidePackages = com.fasterxml.jackson.databind.ObjectMapper.class)
	...
	@Test // DATACMNS-987
	@ClassLoaderConfiguration(hidePackages = com.jayway.jsonpath.DocumentContext.class)
	...
	@Test // DATACMNS-987
	@ClassLoaderConfiguration(hidePackages = org.xmlbeam.ProjectionFactory.class)
